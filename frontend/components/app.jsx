...
import MajorProfIndexContainer from './profs/major_prof_index_container';
...
import RankingIndexContainer from './rankings/ranking_index_container';
...
const App = ({ children }) => (
    <div>
        ...
        <Switch>
            ...
            <Route path='/majorProfs/:schoolId/:majorName' component={MajorProfIndexContainer} />
            ...
            <Route path='/rankings/:regionName' component={RankingIndexContainer} />
            <Route path='/rankings' component={RankingIndexContainer} />
