...
chicago_rating_1 = SchoolRating.create!(reputation: 4, food: 2, happiness: 3, safety: 5, location: 5, facilities: 3, opportunities: 3, internet: 4, social: 2, clubs: 3, comment: "I really like UIC, I believe that I did the right thing when deciding to attend this university. Commuting is not easy, but getting there is always straight forward, I only need to take 1 bus and 2 trains, no walking. Something that does bug me is how you have to look for everything, staff will never aid you by themselves.", school_id: chicago.id)
chicago_rating_2 = SchoolRating.create!(reputation: 3, food: 3, happiness: 4, safety: 3, location: 5, facilities: 3, opportunities: 4, internet: 3, social: 3, clubs: 4, comment: "Majority of people leaving bad ratings for this University have little real-world experience, and are mad they got rejected elsewhere. The university is pretty average, but it still has a lot of the college feel, and it's in the center of Chicago. UIC is what you make of it, you can complain and be bitter or you can make the most and have fun.", school_id: chicago.id)
chicago_rating_3 = SchoolRating.create!(reputation: 2, food: 3, happiness: 1, safety: 2, location: 5, facilities: 1, opportunities: 2, internet: 3, social: 1, clubs: 2, comment: "UIC main selling point is in the center of Chicago but that's about it, the departments are really lackluster and don't prepare you for your future, it only prepares you for the the next class. This is a commuter school so clubs are really small and there isn't much socialization that happens on campus outside of school hours. TLDR don't go to UIC", school_id: chicago.id)
chicago_rating_4 = SchoolRating.create!(reputation: 2, food: 1, happiness: 2, safety: 1, location: 3, facilities: 1, opportunities: 4, internet: 1, social: 2, clubs: 1, comment: "bro just dont come here unless you cant go somewhere else. chicago is great to live in, but this school is not it. Coming from someone who has been on staff here, in student orgs, on dean's list, and genuinely likes school .aside from good and kind professors, this place kinda sucks. financial aid is very useless too.", school_id: chicago.id)
chicago_rating_5 = SchoolRating.create!(reputation: 2, food: 3, happiness: 1, safety: 2, location: 2, facilities: 2, opportunities: 2, internet: 2, social: 2, clubs: 3, comment: "I hate this university", school_id: chicago.id)
chicago_rating_6 = SchoolRating.create!(reputation: 5, food: 2, happiness: 1, safety: 2, location: 4, facilities: 2, opportunities: 5, internet: 5, social: 3, clubs: 2, comment: "The nursing college, no one mentions how the instructors are worst especially pathopham no one of them help just give u hard time. I got shocked because the UIC best school and I found worst instructors English accents bad from 221 class. Best school as UIC should put professional instructors and care about future of students. Unfortunately.", school_id: chicago.id)
chicago_rating_7 = SchoolRating.create!(reputation: 3, food: 2, happiness: 1, safety: 1, location: 3, facilities: 2, opportunities: 2, internet: 3, social: 1, clubs: 1, comment: "I only went here to increase my chances of getting into UIC COD. Otherwise, this university and its faculty are the absolute worst. The quality of teaching at community colleges is better than the quality you'll get here.", school_id: chicago.id)

cuny_rating_1 = SchoolRating.create!(reputation: 3, food: 1, happiness: 1, safety: 5, location: 5, facilities: 2, opportunities: 3, internet: 2, social: 1, clubs: 3, comment: "This school is a great deal economically. People make believe that it is some sort of cheap Harvard that is exceptional, really its a farce. The campus looks like a tire factory, the facilities are gross, the professors are hit and miss and lack enthusiasm and sadly there are intelligent people wasting away here because they can't afford to leave.", school_id: cuny.id)
cuny_rating_2 = SchoolRating.create!(reputation: 5, food: 5, happiness: 4, safety: 5, location: 4, facilities: 4, opportunities: 4, internet: 4, social: 3, clubs: 4, comment: "This is a University for people who want to get their degree and move up in the world. It is not a party school. The geology program is fantastic I love the support I receive from professors and students. Parking is not an issue, class size is good, the food options are good when its not a pandemic year. Overall I really like this school underrated", school_id: cuny.id)
cuny_rating_3 = SchoolRating.create!(reputation: 3, food: 3, happiness: 3, safety: 3, location: 3, facilities: 2, opportunities: 2, internet: 3, social: 3, clubs: 4, comment: "Most departments are great although some are atrocious and really do not care about teaching. I graduated without a loan which would not have been the case had I gone to a private college. However, be careful and keep your receipts. The food choices are scarce and bathroom facilities etc are awful but I guess the school is also on a budget.", school_id: cuny.id)
cuny_rating_4 = SchoolRating.create!(reputation: 3, food: 5, happiness: 1, safety: 5, location: 3, facilities: 1, opportunities: 5, internet: 1, social: 5, clubs: 5, comment: "YOU WILL NOT RECEIVE ANY EMAILS BACK FROM FINANCIAL AID OR ADVISING. THEY DONT HELP WITH ANYTHING. CHECKS YOUR FACTS UNDER STUDENT CENTER TO MAKE SURE U GET FINANCIAL AID.", school_id: cuny.id)
cuny_rating_5 = SchoolRating.create!(reputation: 2, food: 2, happiness: 2, safety: 3, location: 2, facilities: 2, opportunities: 3, internet: 2, social: 1, clubs: 1, comment: "I really didn't enjoy my time here. Granted, I transferred in during the CoronaVirus Pandemic but it just felt mad disorganized, and far from a community. I went to two SUNY schools upstate and my experience there was so much better, the education was much more personalized and I was close with my teachers/advisors. It's the opposite feeling here.", school_id: cuny.id)
cuny_rating_6 = SchoolRating.create!(reputation: 4, food: 4, happiness: 3, safety: 3, location: 4, facilities: 4, opportunities: 3, internet: 4, social: 2, clubs: 3, comment: "Queens college is a very underrated place. I would say better than alot of the SUNY schools IMO. The campus is nice however like others have said the technology is lacking and parking is way too expensive. The profs are great depending on the major and they really want you too do well. Its a school of people who work hard not party really.", school_id: cuny.id)

ucsb_rating_1 = SchoolRating.create!(reputation: 3, food: 1, happiness: 2, safety: 3, location: 3, facilities: 4, opportunities: 3, internet: 1, social: 3, clubs: 4, comment: "Food is very bleh, the internet doesn't work too well. But the professors are classes are really good.", school_id: ucsb.id)
ucsb_rating_2 = SchoolRating.create!(reputation: 5, food: 2, happiness: 2, safety: 2, location: 5, facilities: 4, opportunities: 4, internet: 2, social: 3, clubs: 4, comment: "really wish the school actually cared about its students and their wellbeing. Its reputation is great but the experience is very different once you actually get here", school_id: ucsb.id)
ucsb_rating_3 = SchoolRating.create!(reputation: 4, food: 2, happiness: 4, safety: 5, location: 5, facilities: 4, opportunities: 5, internet: 5, social: 5, clubs: 5, comment: "all good", school_id: ucsb.id)
ucsb_rating_4 = SchoolRating.create!(reputation: 4, food: 3, happiness: 4, safety: 3, location: 5, facilities: 4, opportunities: 3, internet: 3, social: 3, clubs: 2, comment: "As a transfer student everything is okay, I thought ucsb would be more crazy. I also don't live in DP so that's probably why!", school_id: ucsb.id)
ucsb_rating_5 = SchoolRating.create!(reputation: 3, food: 2, happiness: 3, safety: 3, location: 3, facilities: 2, opportunities: 3, internet: 3, social: 4, clubs: 2, comment: "School is the definition of mediocre.", school_id: ucsb.id)

harvard_rating_1 = SchoolRating.create!(reputation: 3, food: 5, happiness: 3, safety: 4, location: 3, facilities: 2, opportunities: 3, internet: 2, social: 3, clubs: 3, comment: "nice", school_id: harvard.id)
harvard_rating_2 = SchoolRating.create!(reputation: 5, food: 1, happiness: 2, safety: 2, location: 3, facilities: 1, opportunities: 4, internet: 1, social: 3, clubs: 3, comment: ":(((", school_id: harvard.id)
harvard_rating_3 = SchoolRating.create!(reputation: 4, food: 2, happiness: 3, safety: 3, location: 4, facilities: 2, opportunities: 3, internet: 2, social: 1, clubs: 1, comment: "Extremely overrated. There are much better local universities to attend rather than this place. First off, you have everyone competing with each other to get accepted. Then you realize that everyone is the same: high 4.3+ GPA, SAT/ACT scores, and volunteer work. It makes you question everything when everyone is the same and depressed. No thanks!", school_id: harvard.id)
harvard_rating_4 = SchoolRating.create!(reputation: 1, food: 1, happiness: 1, safety: 1, location: 1, facilities: 1, opportunities: 1, internet: 1, social: 1, clubs: 1, comment: "The institution that makes your children suffer.", school_id: harvard.id)

bergen_rating_1 = SchoolRating.create!(reputation: 5, food: 4, happiness: 4, safety: 4, location: 5, facilities: 4, opportunities: 4, internet: 5, social: 4, clubs: 5, comment: "Thanks again professor for your inspiration, empathy, and sharing your knowledge about the aviation world with your students. You are gem of Bergen Community College. However, If someone contemplating becoming an airline pilot, it is the perfect place to initiate your aviation voyage with Profesor/Captian William Klappert. Highly recommended!", school_id: bergen.id)
bergen_rating_2 = SchoolRating.create!(reputation: 5, food: 5, happiness: 5, safety: 5, location: 5, facilities: 5, opportunities: 5, internet: 5, social: 5, clubs: 5, comment: "Financial Aid takes forever when you send out an email, but as far as processing documents it takes 3-7 business days I like this college because it is convenient all away around and I wouldn't choose any other 2-year college", school_id: bergen.id)
bergen_rating_3 = SchoolRating.create!(reputation: 4, food: 4, happiness: 4, safety: 4, location: 4, facilities: 5, opportunities: 5, internet: 4, social: 1, clubs: 1, comment: "Love BCC", school_id: bergen.id)
...
macau = Region.find_or_create_by!(name: "澳门")
hk = Region.find_or_create_by!(name: "香港")
tw = Region.find_or_create_by!(name: "台湾")
au = Region.find_or_create_by!(name: "澳洲")
eu = Region.find_or_create_by!(name: "欧洲")
us = Region.find_or_create_by!(name: "北美")
asia = Region.find_or_create_by!(name: "亚洲")
sa = Region.find_or_create_by!(name: "南美")

puts "Creating Macau Schools..."
# Univ of Macau
um = School.find_or_create_by!(
  name: "澳门大学 (University of Macau)",
  state: "澳门",
  city: "澳门",
...
cityu = School.find_or_create_by!(
  name: "澳门城市大学 (City University of Macau)",
  state: "澳门",
  city: "澳门",
  website: "https://www.cityu.edu.mo",
  region_id: macau.id
)
puts "Creating Hong Kong Schools..."
hong_kong_schools = [
  { name: "香港大学 (The University of Hong Kong)", state: "香港", city: "香港",
    website: "https://www.hku.hk", region_id: hk.id },
  { name: "香港中文大学 (The Chinese University of Hong Kong)", state: "香港", city: "香港",
    website: "https://www.cuhk.edu.hk", region_id: hk.id },
  { name: "香港科技大学 (Hong Kong University of Science and Technology)", state: "香港", city: "香港",
    website: "https://www.hkust.edu.hk", region_id: hk.id },
  { name: "香港城市大学 (City University of Hong Kong)", state: "香港", city: "香港",
    website: "https://www.cityu.edu.hk", region_id: hk.id },
  { name: "香港理工大学 (The Hong Kong Polytechnic University)", state: "香港", city: "香港",
    website: "https://www.polyu.edu.hk", region_id: hk.id },
  { name: "香港浸会大学 (Hong Kong Baptist University)", state: "香港", city: "香港",
    website: "https://www.hkbu.edu.hk", region_id: hk.id },
]
hong_kong_schools.each { |s| School.find_or_create_by!(s) }

puts "Creating Taiwan Schools..."
taiwan_schools = [
  { name: "国立台湾大学 (National Taiwan University)", state: "台湾", city: "台北",
    website: "https://www.ntu.edu.tw", region_id: tw.id },
  { name: "国立清华大学 (National Tsing Hua University)", state: "台湾", city: "新竹",
    website: "https://www.nthu.edu.tw", region_id: tw.id },
  { name: "国立成功大学 (National Cheng Kung University)", state: "台湾", city: "台南",
    website: "https://www.ncku.edu.tw", region_id: tw.id },
  { name: "国立阳明交通大学 (National Yang Ming Chiao Tung University)", state: "台湾", city: "新竹",
    website: "https://www.nycu.edu.tw", region_id: tw.id },
  { name: "国立政治大学 (National Chengchi University)", state: "台湾", city: "台北",
    website: "https://www.nccu.edu.tw", region_id: tw.id },
]
taiwan_schools.each { |s| School.find_or_create_by!(s) }

puts "Creating Australia Schools..."
australia_schools = [
  { name: "墨尔本大学 (The University of Melbourne)", state: "VIC", city: "Melbourne",
    website: "https://www.unimelb.edu.au", region_id: au.id },
  { name: "悉尼大学 (The University of Sydney)", state: "NSW", city: "Sydney",
    website: "https://www.sydney.edu.au", region_id: au.id },
  { name: "澳大利亚国立大学 (Australian National University)", state: "ACT", city: "Canberra",
    website: "https://www.anu.edu.au", region_id: au.id },
  { name: "昆士兰大学 (The University of Queensland)", state: "QLD", city: "Brisbane",
    website: "https://www.uq.edu.au", region_id: au.id },
  { name: "新南威尔士大学 (University of New South Wales)", state: "NSW", city: "Sydney",
    website: "https://www.unsw.edu.au", region_id: au.id },
]
australia_schools.each { |s| School.find_or_create_by!(s) }

puts "Creating Europe Schools..."
europe_schools = [
  { name: "牛津大学 (University of Oxford)", state: "England", city: "Oxford",
    website: "https://www.ox.ac.uk", region_id: eu.id },
  { name: "剑桥大学 (University of Cambridge)", state: "England", city: "Cambridge",
    website: "https://www.cam.ac.uk", region_id: eu.id },
  { name: "苏黎世联邦理工学院 (ETH Zurich)", state: "Zurich", city: "Zurich",
    website: "https://www.ethz.ch", region_id: eu.id },
  { name: "帝国理工学院 (Imperial College London)", state: "England", city: "London",
    website: "https://www.imperial.ac.uk", region_id: eu.id },
  { name: "伦敦大学学院 (University College London)", state: "England", city: "London",
    website: "https://www.ucl.ac.uk", region_id: eu.id },
]
europe_schools.each { |s| School.find_or_create_by!(s) }

puts "Creating North America Schools & Associating Existing..."
north_america_schools = [
  { name: "麻省理工学院 (Massachusetts Institute of Technology)", state: "MA", city: "Cambridge",
    website: "https://www.mit.edu", region_id: us.id },
  { name: "斯坦福大学 (Stanford University)", state: "CA", city: "Stanford",
    website: "https://www.stanford.edu", region_id: us.id },
  { name: "加州大学伯克利分校 (University of California, Berkeley)", state: "CA", city: "Berkeley",
    website: "https://www.berkeley.edu", region_id: us.id },
  { name: "哥伦比亚大学 (Columbia University)", state: "NY", city: "New York",
    website: "https://www.columbia.edu", region_id: us.id },
]
north_america_schools.each { |s| School.find_or_create_by!(s) }

# Associate existing US schools with 北美 region
puts "Associating existing US schools with 北美 region..."
School.where(region_id: nil).where("state IN (?) OR state IN (?)",
  %w[NJ MA CA IL NY],
  %w[VIC NSW ACT QLD England Zurich]
).each do |school|
  # Only match the original 5 US seed schools
  if %w[Bergen Harvard UCSB Queens UIC].any? { |k| school.name.include?(k) }
    school.update!(region_id: us.id)
    puts "  → #{school.name} → 北美"
  end
end
