...
ActiveRecord::Schema.define(version: 2026_06_21_031417) do
  ...
  create_table "prof_reviews", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "prof_id"
    t.integer "personality_and_attitude"
    t.integer "academic_and_ability"
    t.integer "resources_and_platform"
  ...
  create_table "profs", force: :cascade do |t|
    ...
    t.index ["major_id"], name: "index_profs_on_major_id"
  ...
  add_foreign_key "profs", "departments"
  add_foreign_key "profs", "majors"
